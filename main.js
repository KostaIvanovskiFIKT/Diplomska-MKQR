...
let qrScale = 5; // Стандардна и почетна вредност размерот на исцртаниот QR код. Може да биде променета само тука.
let qrBorder = 3; // Стандардна и почетна вредност размерот на границата на исцртаниот QR код. Ова е белата (може да биде и други бои) граница околу QR кодот. Може да биде променета само тука.
...
// за грешно пополнето поле доколку полето било означено како грешно.
